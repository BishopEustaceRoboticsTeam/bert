...
//		};
	 ...
	 * <p/>
	 * @param channels Select the generator by specifying the two channels to
	 ...
	 * to output.
	 * <p/>
	 * @param channel The DIO line's PWM generator to get the duty-cycle from.
	 * [1,4]
	 * <p/>
	 ...
	 * @param value The percent duty-cycle to output from the PWM generator.
	 * [0.0,1.0]
	 */
