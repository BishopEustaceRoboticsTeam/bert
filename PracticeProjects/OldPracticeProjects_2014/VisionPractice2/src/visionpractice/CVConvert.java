...
public class CVConvert {
    ...
    public static void rgbToRed(IplImage input, IplImage output) {
        ...
        public static void rgbToBlue(IplImage input, IplImage output) {
        System.out.println("convert color image to blue channel only");
        ...
        int color = 1;  //0=blue, 1=green, 2=red
